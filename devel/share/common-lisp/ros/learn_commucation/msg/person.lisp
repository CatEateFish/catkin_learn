...
(cl:in-package learn_commucation-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learn_commucation-msg:<person> is deprecated: use learn_commucation-msg:person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_commucation-msg:name-val is deprecated.  Use learn_commucation-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_commucation-msg:sex-val is deprecated.  Use learn_commucation-msg:sex instead.")
  (sex m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learn_commucation-msg:age-val is deprecated.  Use learn_commucation-msg:age instead.")
  (age m))
