...
// (in-package learn_commucation.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'learn_commucation/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'learn_commucation/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'learn_commucation/AddTwoInts'; }
};
